...
# native dependencies
(import spork-b/crc :export true)
(import spork-b/json :export true)
(import spork-b/rawterm :export true)
(import spork-b/tarray :export true)
(import spork-b/utf8 :export true)
(import spork-b/zip :export true)
