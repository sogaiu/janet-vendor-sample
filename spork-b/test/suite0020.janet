...
(assert-docs "/spork-b/test")
(assert-docs "/spork-b/argparse")
(assert-docs "/spork-b/fmt")
(assert-docs "/spork-b/generators")
(assert-docs "/spork-b/getline")
(assert-docs "/spork-b/htmlgen")
(assert-docs "/spork-b/http")
(assert-docs "/spork-b/httpf")
(assert-docs "/spork-b/misc")
(assert-docs "/spork-b/msg")
(assert-docs "/spork-b/netrepl")
(assert-docs "/spork-b/path")
(assert-docs "/spork-b/regex")
(assert-docs "/spork-b/rpc")
(assert-docs "/spork-b/schema")
(assert-docs "/spork-b/sh")
(assert-docs "/spork-b/tasker")
(assert-docs "/spork-b/temple")

(assert-docs "spork-b/json")
(assert-docs "spork-b/tarray")
(assert-docs "spork-b/rawterm")
(assert-docs "spork-b/utf8")
